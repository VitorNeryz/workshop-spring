...
import com.nery.LearningSpringBoot.entities.Payment;
...
import com.nery.LearningSpringBoot.repositories.CategoryRepository;
import com.nery.LearningSpringBoot.repositories.OrderItemRepository;
import com.nery.LearningSpringBoot.repositories.OrderRepository;
import com.nery.LearningSpringBoot.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null,Instant.parse("2019-06-20T17:53:07Z"),o2);
		o2.setPayment(pay1);
